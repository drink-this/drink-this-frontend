  ...
  render() {
    return (
      <section className={`${this.props.cname} bg-black bg-opacity-50 absolute top-0 left-0 h-screen w-screen`}>
        <div className="bg-age-pattern border-4 border-blue-300 border-opacity-75 fixed top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 filter drop-shadow-c p-6">
